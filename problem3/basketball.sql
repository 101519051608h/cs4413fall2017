...
game(team_name, player_name, coach_name)
...
CREATE TABLE game(
  ...
  primary key(team_name, player_name, coach_name),
...
CREATE TABLE televised(
  ...
  coach_name varchar(20),
  id int,
  primary key(team_name, player_name, coach_name, id),
  foreign key(team_name) references team,
  foreign key(player_name) references player,
  foreign key(coach_name) references head_coach
)
